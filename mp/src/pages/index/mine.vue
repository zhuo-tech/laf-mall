<template>
  <view class="box">
    ...
    <view v-show="getToken()">
      ...
      <view @click="GoLocation" class="tab">
        <view>
...
.box {
  ...
  .bgc {
    ...
    .datum {
      ...
      border-radius: 30rpx;
      box-shadow: 0rpx 5rpx 6rpx 0rpx #dfdfdf;
      ...
      .wire {
        margin-top: 38rpx;
        width: 100%;
        border-bottom: 1rpx solid #e2e2e4;
      }
      .usable {
        display: flex;
