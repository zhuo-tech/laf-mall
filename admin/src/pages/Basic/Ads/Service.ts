...
export class AdsService extends BasisCrud<HomePageCarouselAndId> {
    ...
    protected override readonly request: CrudRequest<HomePageCarouselAndId> = new UniversalConfigRepository<HomePageCarousel>(MallConfigKey.HOMEPAGE_ADVERTISING)
